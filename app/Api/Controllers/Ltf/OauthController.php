...
class OauthController extends BaseController
{
    ...
    public function oauth(Request $request)
    {
        ...
        //配置
        $ltf_config = new LtfConfigController();
        $ltf_config = $ltf_config->ltf_config($config_id);

        $config = [
            'app_id' => $ltf_config->wx_appid,
            'scope' => 'snsapi_base',
            'oauth' => [
                'scopes' => ['snsapi_base'],
                'response_type' => 'code',
                'callback' => url('api/ltf/weixin/oauth_callback?sub_info=' . $sub_info . '&wx_appid=' . $ltf_config->wx_appid . "&wx_secret=" . $ltf_config->wx_secret . ""),
            ],
    ...
    public function oauth_callback(Request $request)
    {
        ...
        return redirect('/api/ltf/weixin/pay_view?data=' . $data);
    ...
    public function pay_view(Request $request)
    {
        ...
        return view('lft.weixin', compact('data'));
