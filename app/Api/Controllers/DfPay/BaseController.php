...
class BaseController extends \App\Api\Controllers\BaseController
{
    ...
    public function __construct($data)
    {
        ...
        if ($data['mode'] == 1) {//4步模式
            if ($data['memcache_open']) {
                $this->memcache = $data['memcached_server'];
            }
        }
     ...
     */
    function url_data($api = 'T288', $post, $method = 'post', $forward = '', $error_url = '')
    {
     ...
     * @return string
     */
    function create_url($url, $params, $sign_str = '')
    {
    ...
    */
    ...
    public function get_signature($params)
    {
        ...
        usort($params,  array($this,"my_sort"));
