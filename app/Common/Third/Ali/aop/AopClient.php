<?php
namespace App\Common\Third\Ali\aop;

// use \App\Common\Third\Ali\lotusphpruntime\Logger\Logger;

use App\Common\Third\Ali\aop\SignData;
...
class AopClient {
	...
	protected function logCommunicationError($apiName, $requestUrl, $errorCode, $responseTxt) {
		...
		$logger = new Logger;
		$logger->conf["log_file"] = rtrim(LOG_PATH, '\\/') . '/' . "Ali/aop_comm_err_" . $this->appId . "_" . date("Y-m-d") . ".log";
...
// \Frame\Lib\Log::write(json_decode($resp,true),'alireturn.log');
		} catch (\Exception $e) {

			$this->logCommunicationError($sysParams["method"], $requestUrl, "HTTP_ERROR_" . $e->getCode(), $e->getMessage());
			return false;
		}
// \Frame\Lib\Log::write($resp,'alireturn.log');
		//解析AOP返回结果
