...
class XMLUtil
{
    ...
    public static function encryptReqXml($param, $pi_key, $desKey)
    {
        ...
        $sign = RSAUtils::encryptByPrivateKey($sha256SourceSignString, $pi_key);
    ...
    public static function decryptResXml($resultData, &$resData, $desKey, $pu_key)
    {
...
// 		$reqBodyStr = XMLUtil::xmlToString($bodyDom);
        ...
        $decryptStr = \Jdjr\Sdk\RSAUtils::decryptByPublicKey($inputSign, $pu_key);
        ...
        if ($resultObj['result']['code'] != '000000') {
            $data = [
                'is_sign' => $flag,
                'code' => $resultObj['result']['code'],
                'msg' => $resultObj['result']['desc']
