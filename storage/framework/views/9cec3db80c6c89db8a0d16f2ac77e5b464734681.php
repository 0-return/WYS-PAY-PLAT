              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  <div class="layui-btn-container" style="font-size:14px;">
                    <div>
                      <a class="layui-btn layui-btn-primary" lay-href="<?php echo e(url('/merchantpc/addstudent')); ?>" style="display: inline-block;width: 100px;">添加学生</a>
                  ...
                  <script type="text/html" id="table-content-list" class="layui-btn-small">
                    <a class="layui-btn layui-btn-normal layui-btn-xs edit" lay-event="edit" lay-href="<?php echo e(url('/merchantpc/editstudent')); ?>">学生修改</a>
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'pay'){
            layer.open({
              ...
              maxmin: true,
              area: ['90%', '90%'],
              content: "<?php echo e(url('/merchantpc/paystudent?')); ?>"+e.student_no
            });
            ...
            layer.confirm('确定删除此条信息吗?', function(index){
              ...
              layer.close(index);
              $.ajax({
                url : "<?php echo e(url('/api/school/teacher/stu/del')); ?>",
        ...
        $('#Upload').click(function(){
          ...
          $.ajax({   
            url: "<?php echo e(url('/api/school/teacher/stu/import?token=')); ?>"+token,  
            type: 'POST',  
            data: formData,  
            async: false,  
            cache: false,  
