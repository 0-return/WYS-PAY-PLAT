...
<script>
    ...
    layui.config({
        ...
        function getBoards(){ 
            ...
            // 显示修改的内容
            $.post("<?php echo e(url('/api/school/teacher/grade/show')); ?>",
            {
                token:token,
                ...
                $('#school .layui-input-block .layui-form-select .layui-select-title input').val(school_name);
        ...
        $('.submit').on('click', function(){
            $.post("<?php echo e(url('/api/school/teacher/grade/save')); ?>",
            {
                token:token,
