  ...
  <script src="<?php echo e(asset('/layuiadmin/layui/jquery.qrcode.min.js')); ?>"></script>
    ...
    layui.config({
      ...
      table.render({
        ...
        ,url: "<?php echo e(url('/api/fuiou/store_list')); ?>"
        ,method: 'post'
        ,where:{
          token:token,  
          store_id:store_id            
    ...
    $('#Upload').click(function(){
      ...
      $.ajax({   
        url: "<?php echo e(url('/api/fuiou/import_mercId?token=')); ?>"+token+"&store_id="+store_id,  
        type: 'POST',  
        data: formData,  
        async: false,  
        cache: false,  
    ...
    var active = {
      ...
      batchdel: function(){
        ...
        layer.confirm('确定删除吗？', function(index) {   
          ...
          $.post("<?php echo e(url('/api/fuiou/del_store')); ?>",
          {
              token:token,
              store_id:store_id,
              mchnt_cd:arrs.join()               
