...
<script>
    ...
    layui.config({
        ...
        $(".transfer").bind("input propertychange",function(event){
          ...
          $.post("<?php echo e(url('/api/basequery/bank')); ?>",
          {
              token:token,
              bankname:$(this).val(),                        
        ...
        $(".userbox").on("click",".list",function(){
          ...
          $.post("<?php echo e(url('/api/basequery/sub_bank')); ?>",
            {
                token:token,
        ...
        function nostore(){
            // 商户类型查询
            $.ajax({
                url : "<?php echo e(url('/api/basequery/store_type')); ?>",
                data : {token:token},
                type : 'get',
                success : function(data) {
                    // console.log(data);
            ...
            // 商户经营性质
            $.ajax({
                url : "<?php echo e(url('/api/basequery/store_category')); ?>",
                data : {token:token},
                type : 'get',
                success : function(data) {
                    // console.log(data);
        ...
        var uploadInst = upload.render({
            url : "<?php echo e(url('/api/basequery/webupload?act=images')); ?>"+'&token='+token+"&img_type="+"2"+"&attach_name="+"head_sfz_img_a_url"+"&type="+"img", //提交到的地址 可以自定义其他参数
        ...
        //身份证反面
        var uploadInst = upload.render({
            url : "<?php echo e(url('/api/basequery/webupload?act=images')); ?>"+'&token='+token+"&img_type="+"3"+"&attach_name="+"head_sfz_img_b_url"+"&type="+"img",  //提交到的地址 可以自定义其他参数
        ...
        //上传银行卡正面
        var uploadInst = upload.render({
            url : "<?php echo e(url('/api/basequery/webupload?act=images')); ?>"+'&token='+token+'&img_type='+4,  //提交到的地址 可以自定义其他参数
        ...
        //营业执照
        var uploadInst = upload.render({
            url : "<?php echo e(url('/api/basequery/webupload?act=images')); ?>"+'&token='+token+"&img_type="+"1"+"&attach_name="+"store_license_img"+"&type="+"img",  //提交到的地址 可以自定义其他参数
        ...
        //持卡人身份证反面
        var uploadInst = upload.render({
            url : "<?php echo e(url('/api/basequery/webupload?act=images')); ?>"+'&token='+token+'&img_type='+ 3,  //提交到的地址 可以自定义其他参数
