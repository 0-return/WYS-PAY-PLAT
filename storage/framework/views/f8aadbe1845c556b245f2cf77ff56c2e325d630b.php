          ...
          <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
              <div class="layui-card"> 
                <div class="layui-card-header">赏金列表</div>
                      ...
                      <div class="layui-form-item">                          
                        <div class="layui-input-block" style="margin-left:0">
                            <select name="status" id="status" lay-filter="status">
                              ...
                              <option value="01">已结算</option>
                              <option value="02">未结算</option>
                            </select>
                        </div>
                      </div>
                    </div>
      ...
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.render({
            ...
            ,cols: [[
              ...
              ,{field:'user_name', title: '业务员'}
              ,{field:'phone', title: '手机号'}
              ,{field:'money', title: '赏金金额'}
              ,{field:'source_desc',  title: '赏金来源'}                             
              ,{field:'settlement_desc', title: '结算状态'}
              ,{field:'created_at',  title: '创建时间'} 
              ,{field:'updated_at',  title: '结算时间'}
            ]]
            ,response: {
