...
<body>
  ...
  <script src="<?php echo e(asset('/layuiadmin/layui/layui.js')); ?>"></script> 
    ...
    layui.config({
      ...
      $('.addshouyin').attr('lay-href',"<?php echo e(url('/user/addshouyin?store_id=')); ?>"+store_id+"&store_name="+store_name);  
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/qwx/code_list')); ?>"
            ,method: 'post'
            ,where:{
              token:token,
              store_id:store_id
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'del'){
            ...
            layer.confirm('确认删除此消息?',{icon: 2}, function(index){
              $.post("<?php echo e(url('/api/qwx/del_code')); ?>",
              {
