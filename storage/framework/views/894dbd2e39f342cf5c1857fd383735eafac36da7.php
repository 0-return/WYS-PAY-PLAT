              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  <div class="layui-btn-container" style="font-size:14px;">
                    <a class="layui-btn layui-btn-primary" lay-href="<?php echo e(url('/merchantpc/addteacher')); ?>" style="display: block;width: 100px;">添加教师</a>
                  ...
                  <script type="text/html" id="table-content-list">
                    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="edit" lay-href=""><i class="layui-icon layui-icon-edit"></i>修改</a>
                    <a class="layui-btn layui-btn-normal layui-btn-xs" lay-event="stop">停用</a>
                  </script>
                </div>
              </div>
            </div>
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/school/teacher/ter/lst')); ?>"
            ,method: 'post'
            ,where:{
              token:token,              
            }
            ...
            ,page: true
            ,cols: [[
                {field:'school_name', width:250, title: '学校名称'}
                ,{field:'name', width:250, title: '教师姓名'}
