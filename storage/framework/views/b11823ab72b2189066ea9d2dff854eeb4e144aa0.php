...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <link href="<?php echo e(asset('/user/css/bootstrap.min.css?v=3.3.5')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('/user/css/animate.min.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('/user/css/total.css')); ?>" rel="stylesheet">
    <link href="<?php echo e(asset('/user/css/btn.css')); ?>" rel="stylesheet">
    <link rel="stylesheet" href="<?php echo e(asset('/layuiadmin/layui/css/layui.css')); ?>" media="all">
    <link rel="stylesheet" href="<?php echo e(asset('/user/css/layer.css')); ?>">
    <!-- <link href="<?php echo e(asset('/user/css/plugins/sweetalert/sweetalert.css')); ?>" rel="stylesheet"> -->
    <style>
        ...
        .add{
            ...
            float: left;
            margin-top: 5px;
            background: url("<?php echo e(asset('/user/img/plus.gif')); ?>") no-repeat;
        ...
        .minus{
            ...
            float: left;
            margin-top: 5px;
            background: url("<?php echo e(asset('/user/img/minus.gif')); ?>") no-repeat;
        }
...
<!-- <script src="<?php echo e(asset('/user/js/layer.js')); ?>"></script> -->
<script>
      ...
      var layer = layui.layer;
        ...
        $('.permission_lists').on("click",".del_perm",function () {
            ...
            layer.confirm('确定删除此条信息吗?', function(index){
              ...
              $.ajax({
                url : "<?php echo e(url('/api/role_permission/del_permission')); ?>",
