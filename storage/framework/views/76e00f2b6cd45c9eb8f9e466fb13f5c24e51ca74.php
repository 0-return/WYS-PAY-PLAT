              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  ...
                  <script type="text/html" id="table-content-list">
                    ...
                    <a class="layui-btn layui-btn-normal layui-btn-xs edit" lay-event="edit" lay-href="<?php echo e(url('/merchantpc/edittemplate')); ?>">模板修改</a>
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'detail'){ //删除
            ...
            layer.open({
              ...
              maxmin: true,
              area: ['70%', '80%'],
              content: "<?php echo e(url('/merchantpc/examinetemplate?')); ?>"+e.stu_order_type_no
            });
          }
        });
