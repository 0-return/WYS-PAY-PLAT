              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  <div class="layui-btn-container" style="font-size:14px;">
                    <a class="layui-btn layui-btn-primary" lay-href="<?php echo e(url('/user/addappmsg')); ?>" style="display: block;width: 122px;">添加app消息</a>
                      ...
                      <div class="layui-form-item">                          
                        <div class="layui-input-block" style="margin-left:0">
                            <select name="schooltype" id="schooltype" lay-filter="schooltype">
                                ...
                                <option value="news">新闻/消息</option>
                  ...
                  <script type="text/html" id="imgTpl">
                    <img style="display: inline-block;height: 100%;" src= {{d.icon_url }}>
                  </script>
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/user/notice_news')); ?>"
            ,method: 'post'
            ,where:{
              token:token,              
            }
            ...
            ,cellMinWidth: 150
            ,cols: [[
                {field:'icon_url', title: '封面图片',templet: '#imgTpl'}
                ,{field:'title', title: '消息标题'}
                ,{field:'type_desc',  title: '消息类型',templet: '#type'}   
                ,{field:'redirect_url',  title: '消息链接'}             
         ...
         table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'del'){
            layer.confirm('确认删除此消息?',{icon: 2}, function(index){
              ...
              $.ajax({
                url : "<?php echo e(url('/api/user/del_notice_news')); ?>",
