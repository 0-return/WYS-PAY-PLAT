    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/school/teacher/order/lst')); ?>"
            ,method: 'post'
            ,where:{
              token:token,              
            }
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'see'){
            layer.open({
              ...
              maxmin: true,
              area: ['60%', '70%'],
              content: "<?php echo e(url('/merchantpc/seepayrecord?')); ?>"+e.out_trade_no
            });
            ...
            layer.open({
              ...
              maxmin: true,
              area: ['80%', '70%'],
              content: "<?php echo e(url('/merchantpc/minoritem?')); ?>"+e.out_trade_no
            });
