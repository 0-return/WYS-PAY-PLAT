...
<div class="layadmin-user-login layadmin-user-display-show" id="LAY-user-login" style="display: none;">
    ...
    <div class="layadmin-user-login-main">
        <div class="layadmin-user-login-box layadmin-user-login-header">
            <h2 style="color:#fff;padding-top: 40px;font-size: 22px;">欢迎您登陆<div class="js_name"></div></h2>
        </div>
        ...
        <div class="layadmin-user-login-box layadmin-user-login-body layui-form">
            ...
            <div class="layui-form-item" style="margin-bottom: 20px;padding: 30px 0;">
                ...
                <a href="<?php echo e(url('/mb/forget')); ?>" class="layadmin-user-jump-change layadmin-link"
            ...
            $.get("<?php echo e(url('/api/merchant/login')); ?>",
                {
                    ...
                    if (res.status == 1) {
                        ...
                        layer.msg('登录成功', {
                            ...
                            location.href = "<?php echo e(url('/mb/index')); ?>"; //后台主页
                        });
