              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  <div class="layui-btn-container">                    
                    <a class="layui-btn layui-btn-primary addschool" lay-href="<?php echo e(url('/merchantpc/addschool')); ?>">添加学校</a>
                  </div>
      ...
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'tongbu'){//同步+++++
            ...
            $('.shouquan').attr('lay-href',"<?php echo e(url('/merchantpc/alipayauth?')); ?>"+e.store_id)
            ...
            $('.edit').attr('lay-href',"<?php echo e(url('/merchantpc/editschool?')); ?>"+e.store_id)

          }else if(layEvent === 'branch'){
            localStorage.setItem('parsent_store_id', e.store_id);
            $('.branch').attr('lay-href',"<?php echo e(url('/merchantpc/branchschool?store_id=')); ?>"+e.store_id+"&school_name="+e.school_name)
          }
