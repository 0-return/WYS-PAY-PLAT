...
<div class="layui-fluid">
    ...
    <div class="layui-card">
      <div class="layui-card-header">添加缴费模板</div>
                  ...
                  <div class="layui-col-md10">
                    <div class="layui-card">
                      ...
                      <div class="layui-card-body">
                        ...
                        <!-- <script type="text/html" id="test-table-switchTp">
                            <input type="checkbox" name="item_mandatory" lay-skin="switch" lay-text="是|否" lay-filter="test-table-sexDemo" checked="" value="Y">
                        </script> -->
...
<input type="hidden" class="arr" value="">
...
<script>
    ...
    layui.config({
        ...
        var tablenew = [{"item_name":"","item_price":"","item_number":"1","item_mandatory":"Y"}];//定义一个空数组

        var tableBox = table.render({
            elem: '#test-table-cellEdit'
            // ,url:"<?php echo e(asset('/layuiadmin/json/template.js')); ?>"
            ,page: true 
            ,cellMinWidth: 150   
            ,cols: [[                
                ...
                // ,{field:'item_mandatory', title:'是否必交(Y或N)', templet: '#test-table-switchTp', unresize: true}
                ,{fixed: 'right', width:150, align:'center', title: '操作',toolbar: '#test-table-switchTpl'} 
                // ,{field:'item_mandatory',event:'isclsoe',width:150, align:'center', toolbar: '#test-table-switchTpl',title: '是否必交'}
                // ,{type:'checkbox', fixed: 'right',field:'item_mandatory',title: '是否必交'}
            ]]
            ...
            ,done: function(res){              
                ...
                $("#addhang").off('click').on('click',function(){//$("#addhang").click(function()  这样写会让表格成倍增加,不可取
                    ...
                    var _dw={"item_name":"","item_price":"","item_number":"1","item_mandatory":"Y"};
                    tablenew.push(_dw);
                    tableBox.reload({
                        data:tablenew
                    })//点击添加行之后渲染表格
        ...
        form.on('switch(test-table-sexDemo)', function(obj){
            var a=obj.elem.parentElement.parentElement;
            console.log(obj); //当前行数据
            console.log(obj.elem.checked); //当前行数据
        ...
        $('.submit').on('click', function(){
            ...
            $.post("<?php echo e(url('/api/school/teacher/template/add')); ?>",
            {
                token:token,
