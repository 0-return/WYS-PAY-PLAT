...
<script>
    ...
    layui.config({
        ...
        formSelects.config('range', {
            searchUrl: "<?php echo e(url('/api/user/get_sub_users?token=')); ?>"+token+'&self='+1,
            ...
            // url:"<?php echo e(url('/api/school/teacher/class/lst?token=')); ?>"+token
            // url:"<?php echo e(url('/api/user/get_sub_users?token=')); ?>"+token
        });

        // $('#range').attr('xm-select-search',"<?php echo e(url('/api/user/get_sub_users?token=')); ?>"+token)
