...
<head>
  ...
  <link rel="stylesheet" href="<?php echo e(asset('/layuiadmin/style/template.css')); ?>" media="all">
  <style>
  ...
  <script type="text/javascript" src="<?php echo e(asset('/school/js/jsencrypt.min.js')); ?>"></script>
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        // 查看赏金金额
        $.ajax({
          url : "<?php echo e(url('/api/wallet/source_query')); ?>",
        ...
        // 查看是否绑定支付宝
        $.ajax({
          url : "<?php echo e(url('/api/wallet/account')); ?>",
          data : {token:token},
          type : 'post',
        ...
        $('.submit1').click(function(){
          ...
          $.post("<?php echo e(url('/api/user/check_pay_password')); ?>",
          {
            token:token,
            sign:data 
          },
          function (res){
            console.log(res);
            if(res.status==1){
              $.post("<?php echo e(url('/api/wallet/out_wallet')); ?>",
              {
                  token:token,
        ...
        $('.submit2').click(function(){ 
          ...
          $.post("<?php echo e(url('/api/wallet/add_account')); ?>",
          {
            token:token,
            code:$('.js-code').val(),
        ...
        $('#tixianjilu').click(function(){
          $(this).attr('lay-href',"<?php echo e(url('/user/putforward?')); ?>"+user_id)
        })
