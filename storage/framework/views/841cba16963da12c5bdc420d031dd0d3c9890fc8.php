...
<!--                     <div>
                      <a class="layui-btn layui-btn-primary" lay-href="<?php echo e(url('/merchantpc/paymentitem')); ?>" style="display: inline-block;width: 120px;">收费项目列表</a>
                    </div> -->
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/school/teacher/stat/pay')); ?>"
            ,method: 'post'
            ,where:{
              token:token,              
            }
            ...
            ,cols: [[
                ...
                ,{field:'not_pay_amount',  title: '未缴金额'}
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'shenhe'){ //审核
            ...
            window.location.href="<?php echo e(url('/api/school/teacher/order/lst')); ?>"+"?token="+token+"&stu_order_batch_no="+e.stu_order_batch_no+"&excel="+"1"+"&file_name="+e.charge_name+"-明细";
          }
        });
        ...
        window.location.href="<?php echo e(url('/api/school/teacher/stat/pay')); ?>"+"?token="+token+"&store_id="+store_id+"&stu_grades_no="+stu_grades_no+"&stu_class_no="+stu_class_no+"&stu_order_batch_no="+stu_order_batch_no+"&pay_start_time="+pay_start_time+"&pay_end_time="+pay_end_time+"&export="+"1"+"&export_name="+"缴费记录管理列表";
        })
