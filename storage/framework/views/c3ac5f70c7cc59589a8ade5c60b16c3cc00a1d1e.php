    ...
    layui.config({
      ...
      $('.layui-card-header').html(agentName);
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/user/user_ways_default')); ?>"
            ,method: 'post'
            ,where:{
              token:token,   
              user_id:user_id           
        ...
        $('.submit').click(function(){
          $.post("<?php echo e(url('/api/user/edit_user_store_all_rate')); ?>",
          {
              token:token,
              user_id:user_id,
              ways_type:$('.type').val(),
        ...
        $('.submits').click(function(){
          $.post("<?php echo e(url('/api/user/edit_user_un_store_all_rate')); ?>",
          {
              token:token,
              user_id:user_id,
              ways_type:$('.types').val(),
         ...
         $('.submitsao').click(function(){
          $.post("<?php echo e(url('/api/user/edit_user_unqr_store_all_rate')); ?>",
          {
              token:token,
              user_id:user_id,
              ways_type:$('.types').val(),
