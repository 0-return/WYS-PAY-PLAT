    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-side-scroll">
          ...
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            ...
            <li data-name="component" class="layui-nav-item">
              <a lay-href="<?php echo e(url('/merchantpc/home')); ?>" lay-tips="主页" lay-direction="2">
                    ...
                    <dd>
                      <a href="javascript:;">班级</a>
                        <dl class="layui-nav-child" style="padding-left:15px;">
                          ...
                          <!-- <dd><a lay-href="<?php echo e(url('/merchantpc/assignteacher')); ?>">分配教师列表</a></dd> -->
                        </dl>
                    </dd>
                  </dl>
                </dd>                
            ...
            <!-- <li data-name="template" class="layui-nav-item">
              ...
              <dl class="layui-nav-child">
                <dd><a lay-href="<?php echo e(url('/user/role')); ?>">角色管理</a></dd>
              </dl>
              <dl class="layui-nav-child">
                <dd><a lay-href="<?php echo e(url('/user/power')); ?>">权限管理</a></dd>
              </dl>
            </li> -->
      ...
      <div class="layadmin-pagetabs" id="LAY_app_tabs">
        ...
        <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
          <ul class="layui-tab-title" id="LAY_app_tabsheader">
            <li lay-id="<?php echo e(url('/merchantpc/home')); ?>" lay-attr="<?php echo e(url('/merchantpc/home')); ?>" class="layui-this">主页</li>
          </ul>
        </div>
      </div>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="<?php echo e(url('/merchantpc/home')); ?>" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
