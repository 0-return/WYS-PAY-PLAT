      ...
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{align:'center',width:230, fixed: 'right', toolbar: '#table-content-list',title: '操作'}
            ]]
            ,response: {
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'assign'){ //分配教师
            layer.open({
              type: 2,
              title: e.stu_class_name+'--分配教师',
              shade: false,
              maxmin: true,
              area: ['60%', '50%'],
              content: "<?php echo e(url('/merchantpc/assignteacher?mer_id=')); ?>"+e.merchant_id+"&store_id="+e.store_id+"&classno="+e.stu_class_no
            });
