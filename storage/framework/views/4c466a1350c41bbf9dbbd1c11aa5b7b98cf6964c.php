              ...
              <div class="layui-card">
                ...
                <div class="layui-card-body">
                  <div class="layui-btn-container" style="font-size:14px;">
                    <a class="layui-btn layui-btn-primary" lay-href="<?php echo e(url('/merchantpc/addgrade')); ?>" style="margin-bottom:0">添加年级</a>
                  ...
                  <script type="text/html" id="table-content-list">
                    <a class="layui-btn layui-btn-normal layui-btn-xs edit" lay-event="edit" lay-href="<?php echo e(url('/merchantpc/editgrade')); ?>">年级修改</a>
