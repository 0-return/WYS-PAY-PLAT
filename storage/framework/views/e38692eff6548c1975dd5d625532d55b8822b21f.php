            ...
            <div class="layui-form" lay-filter="component-form-group">
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <input type="text" name="schoolname" lay-verify="schoolname" autocomplete="off" placeholder="请输入门店名称" class="layui-input name" disabled="">
                    </div>
                </div>
...
<script>
    ...
    layui.config({
        ...
        form.on('select(classify)', function(data){            
            ...
            // 选择设备类型
            $.ajax({
                url : "<?php echo e(url('/api/device/device_type')); ?>",
        ...
        $('.submit').on('click', function(){
            $.post("<?php echo e(url('/api/device/add')); ?>",
            {
                token:token,
                store_id:store_id,
                type:$('.classifyid').val(),
