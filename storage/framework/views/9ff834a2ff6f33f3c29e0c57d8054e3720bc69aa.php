...
<body class="layui-layout-body">
    ...
    <div class="layui-layout layui-layout-admin">
          ...
          <ul class="layui-nav layui-nav-tree box" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
            <li data-name="home" class="layui-nav-item layui-nav-itemed item_daili" data="代理商管理">
              ...
              <dl class="layui-nav-child">                
                ...
                <dd data-name="grid"><a lay-href="<?php echo e(url('/user/qrcode')); ?>" data="我的激活码">我的激活码</a></dd>              
              </dl>
            </li>
            ...
            <li data-name="template" class="layui-nav-item item_mendian" data='门店管理'>
              ...
              <dl class="layui-nav-child">
                ...
                <dd><a lay-href="<?php echo e(url('/user/tradelist')); ?>" data="交易流水">交易流水</a></dd>
                <dd><a lay-href="<?php echo e(url('/user/reconciliation?user_id=&user_name=')); ?>" data="对账查询">对账查询</a></dd>
                <dd><a lay-href="<?php echo e(url('/user/flowerlist')); ?>" data="花呗分期流水">花呗分期流水</a></dd>
                <dd><a lay-href="<?php echo e(url('/user/makemoney')); ?>" data="商户打款记录">商户打款记录</a></dd>
              </dl>
            </li>
            ...
            <li data-name="template" class="layui-nav-item item_zhifu" data='交易数据管理'>
              ...
              <dl class="layui-nav-child">
                <dd><a lay-href="<?php echo e(url('/user/transactionlist')); ?>" data='交易榜'>交易榜</a></dd>                
              </dl>
            </li>
            <li data-name="template" class="layui-nav-item item_huodong" data='活动管理'>
              ...
              <dl class="layui-nav-child">
                ...
                <dd data-name="classmanage" class="layui-nav-itemed">
                  ...
                  <dl class="layui-nav-child">
                    <dd><a lay-href="<?php echo e(url('/user/jdwhitebar')); ?>" data='白条数据录入'>白条数据录入</a></dd>
                  </dl>
                </dd>    
              </dl>
            </li>            
            ...
            <li data-name="template" class="layui-nav-item item_shangjin" data='赏金管理'>
              ...
              <dl class="layui-nav-child">
                <dd><a lay-href="<?php echo e(url('/user/yytong')); ?>" data='银盈通'>银盈通</a></dd>
            ...
            <li data-name="template" class="layui-nav-item item_ad" data='广告管理'>
              ...
              <dl class="layui-nav-child">
                <dd><a lay-href="<?php echo e(url('/user/adcatelist')); ?>" data='广告类别'>广告类别</a></dd>
              </dl>
              <dl class="layui-nav-child">
            ...
            <li data-name="template" class="layui-nav-item item_code" data='二维码统一管理'>
              ...
              <dl class="layui-nav-child">
                ...
                <dd><a lay-href="<?php echo e(url('/user/percode')); ?>" data='个人码合并'>个人码合并</a></dd>
              </dl>              
            </li>
            ...
            <li data-name="template" class="layui-nav-item item_juese" data='角色权限管理'>
              ...
              <dl class="layui-nav-child">
                ...
                <dd><a lay-href="<?php echo e(url('/user/power')); ?>" data='权限管理'>权限管理</a></dd>
              </dl>
            </li>
            <li data-name="template" class="layui-nav-item item_zhifu" data='支付配置'>
              ...
              <dl class="layui-nav-child">
                ...
                <dd><a lay-href="<?php echo e(url('/user/jdconfigure')); ?>" data='京东金融配置'>京东金融配置</a></dd>
                <dd><a lay-href="<?php echo e(url('/user/newworld')); ?>" data='新大陆配置'>新大陆配置</a></dd>
                <dd><a lay-href="<?php echo e(url('/user/hrtconfig')); ?>" data='和融通配置'>和融通配置</a></dd>
              </dl>
            </li>
              ...
              <dl class="layui-nav-child">
                ...
                <!-- <dd>
                  ...
                  <dl class="layui-nav-child" style="padding-left:15px;">
                    <dd><a lay-href="<?php echo e(url('/user/devicemanage')); ?>">设备列表</a></dd>
                    <dd><a lay-href="<?php echo e(url('/user/deviceconfig')); ?>">设备配置</a></dd>                    
                  </dl>
                </dd>  --> 
      ...
      <div class="layadmin-pagetabs" id="LAY_app_tabs">
        ...
        <div class="layui-tab" lay-unauto lay-allowClose="true" lay-filter="layadmin-layout-tabs">
          <ul class="layui-tab-title" id="LAY_app_tabsheader">
            <li lay-id="<?php echo e(url('/user/agentlist')); ?>" lay-attr="<?php echo e(url('/user/agentlist')); ?>" class="layui-this">代理商列表</li>
          </ul>
        </div>
      </div>
      ...
      <div class="layui-body" id="LAY_app_body">
        <div class="layadmin-tabsbody-item layui-show">
          <iframe src="<?php echo e(url('/user/agentlist')); ?>" frameborder="0" class="layadmin-iframe"></iframe>
        </div>
      </div>
  ...
  layui.config({
    ...
    $('.seetixian').click(function(){
      $(this).attr('lay-href','<?php echo e(url('/user/cashwithdrawal?')); ?>'+$(this).attr('data'))
    })
