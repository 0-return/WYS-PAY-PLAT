...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('/school/css/mobileSelect.css')); ?>">
...
<div class="box">
    ...
    <div class="item" style="margin-top:.2rem;">
        <label>学校</label>
        <span class="school"><?php echo e($_GET['school_name']); ?></span>
    </div>
    <div class="item">
        <label><i>*</i>年级</label>
...
<div class="server">有梦想科技提供技术服务</div>

<input type="hidden" class="stu_grades_no" value="<?php echo e($_GET['stu_grades_no']); ?>">
<input type="hidden" class="stu_class_no" value="<?php echo e($_GET['stu_class_no']); ?>">
...
<!-- <script type="text/javascript" src="<?php echo e(asset('/school/js/mobileSelect.js')); ?>"></script> -->
...
<script>
	...
	var stu_grades_no="<?php echo e($_GET['stu_grades_no']); ?>";
	var stu_class_no="<?php echo e($_GET['stu_class_no']); ?>";
	var open_id="<?php echo e($_GET['open_id']); ?>";
	...
	$('.ul_con1').on("click","li",function(){//选择年级
		...
		// 班级
        $.post("<?php echo e(url('/api/consumer/h5/class/lst')); ?>",
        {
        	store_id:store_id,
    ...
    $(document).ready(function(){
        // 年级
        $.post("<?php echo e(url('/api/consumer/h5/grade/lst')); ?>",
        {
            store_id:store_id
        },function(res){
            console.log(res);
    ...
    $('.btn_jf').click(function(){
    	$.post("<?php echo e(url('/api/consumer/h5/info/check')); ?>",
        {
        	store_id:store_id,
