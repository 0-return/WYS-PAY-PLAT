         ...
         <div class="layui-row layui-form">
            ...
            <div class="layui-col-md6"> 
                <div class="layui-form-item">                    
                    ...
                    <div class="layui-input-block" style="width:130px;overflow: hidden;display: inline-block;margin-left:20px;">
                        <div class="img license3"><img src="<?php echo e(asset('/school/images/zanwu.png')); ?>"></div>
                        <label class="layui-form-label">其他照片1</label>
                    </div>
                    <div class="layui-input-block" style="width:130px;overflow: hidden;display: inline-block;margin-left:20px;">
                        <div class="img license4"><img src="<?php echo e(asset('/school/images/zanwu.png')); ?>"></div>
...
<div id="license5" class="hide" style="display: none"><img style="width:100%;height:100%" src="<?php echo e(asset('/school/images/zanwu.png')); ?>"></div> 
...
<script>
    ...
    layui.config({
        ...
        $.post("<?php echo e(url('/api/merchant/store')); ?>",
        {
            token:token,
            store_id:store_id         
            ...
            if(res.status==1){
                ...
                if(res.data.store_info.store_img_a=='' || res.data.store_info.store_img_a=='undefined'){
                    $('.store1 img').attr('src',"<?php echo e(asset('/school/images/zanwu.png')); ?>");
                    $('#store1 img').attr('src',"<?php echo e(asset('/school/images/zanwu.png')); ?>");                    
                }else{
