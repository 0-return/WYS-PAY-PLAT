      ...
      <div class="layui-card-body layui-row layui-col-space10">
        <div class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="schoolname" lay-verify="schoolname" autocomplete="off" placeholder="请输入学校名称" class="layui-input studentname">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">学生身份证号</label>
                <div class="layui-input-block">
                    <input type="text" name="schoolname" lay-verify="schoolname" autocomplete="off" placeholder="请输入学生身份证号" class="layui-input studentid">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">学生学号</label>
                <div class="layui-input-block">
                    <input type="text" name="schoolname" lay-verify="schoolname" autocomplete="off" placeholder="请输入学校名称" class="layui-input studentnum">
                </div>
            </div>
      ...
      <div class="layui-card-body layui-row layui-col-space10">
        <div class="layui-form">
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="text" name="schoolname" lay-verify="schoolname" autocomplete="off" placeholder="请输入学校名称" class="layui-input parentname">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">家长电话</label>
                <div class="layui-input-block">
                    <input type="text" name="schoolname" lay-verify="schoolname" autocomplete="off" placeholder="请输入学校名称" class="layui-input parentphone">
                </div>
            </div>            
            <div class="layui-form-item grade">
...
<script>
    ...
    var s_status = localStorage.getItem("s_status");
    var s_student_user_relation = localStorage.getItem("s_student_user_relation");

    var s_student_no = localStorage.getItem("s_student_no");
    var s_student_identify = localStorage.getItem("s_student_identify");
    ...
    layui.config({
        ...
        $('.schooltypeid').val(s_store_id);
        $('.statusid').val(s_status);
        ...
        function getBoards(){ 
                ...
                success : function(data) {
                    ...
                    var optionStr = "";
                        for(var i=0;i<data.data.length;i++){
                            ...
                            optionStr += "<option value='" + data.data[i].store_id + "' "+((s_store_id==data.data[i].store_id)?"selected":"")+">"
            ...
            // 每条信息
            $.ajax({
                url : "<?php echo e(url('/api/school/teacher/stu/show')); ?>",
                data : {token:token,student_no:s_student_no,student_identify:s_student_identify},
                type : 'post',
        ...
        $('.submit').on('click', function(){
            $.post("<?php echo e(url('/api/school/teacher/stu/save')); ?>",
            {
                token:token,
