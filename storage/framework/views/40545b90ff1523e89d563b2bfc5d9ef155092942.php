              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  ...
                  <div class="layui-btn-container" style="font-size:14px;">
                    <a class="layui-btn layui-btn-primary" lay-href="<?php echo e(url('/user/adddevice')); ?>" id="agent" data-id="1" style="margin-bottom:0;">添加设备</a>
                  ...
                  <script type="text/html" id="table-content-list" class="layui-btn-small">
                    <a class="layui-btn layui-btn-danger layui-btn-xs edit" lay-event="edit" lay-href="<?php echo e(url('/user/editdevice')); ?>">设备修改</a>
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'del'){ //审核
            layer.confirm('确定删除此条信息吗?', function(index){
              ...
              $.ajax({
                url : "<?php echo e(url('/api/device/del')); ?>",
