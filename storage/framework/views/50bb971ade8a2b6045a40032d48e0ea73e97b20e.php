    ...
    layui.config({
      ...
      $(document).ready(function(){        
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/deposit/pay_order_list')); ?>"
            ,method: 'post'
            ,where:{
              token:token         
            }
        ...
        form.on('select(agent)', function(data){
          ...
          // 选择收银员
          $.ajax({
              url : "<?php echo e(url('/api/basequery/merchant_lists')); ?>",
        ...
        function exportdata(){
          ...
          window.location.href="<?php echo e(url('/api/export/MerchantOrderExcelDown')); ?>"+"?token="+token+"&store_id="+store_id+"&merchant_id="+merchant_id+"&order_status="+order_status+"&ways_source="+ways_source+"&time_start="+time_start+"&time_end="+time_end+"&out_trade_no="+out_trade_no;     
