              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  <div class="layui-btn-container" style="font-size:14px;">
                    <a class="layui-btn layui-btn-primary" lay-href="<?php echo e(url('/user/addbanner')); ?>" style="display: block;width: 122px;">添加banner</a>
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        table.render({
            ...
            ,url: "<?php echo e(url('/api/user/banners')); ?>"
            ,method: 'post'
            ,where:{
              token:token,              
            }
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'del'){
            layer.confirm('确认删除banner信息?',{icon: 2}, function(index){
              ...
              $.ajax({
                url : "<?php echo e(url('/api/user/del_banners')); ?>",
