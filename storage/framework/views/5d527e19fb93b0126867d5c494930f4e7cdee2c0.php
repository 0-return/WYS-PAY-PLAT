...
<div class="logo-box">
    <div class="logo-img">
        <img src="<?php echo e(asset('/phone/img/logo.png')); ?>">
    </div>
    <div class="logo-con">
        <div class="input-con">
            <label>账号</label>
    ...
    <div class="password-con">
        ...
        <div class="pass-sign"><a href="<?php echo e(url('/school/forget')); ?>">忘记密码</a></div>
    </div>
    <div class="submit">
...
<input type="hidden" class="js_type" value="<?php echo e($_GET['login_type']); ?>">
<input type="hidden" class="s_code" value="<?php echo e($_GET['s_code']); ?>">
...
<script>
    ...
    //     $.post("<?php echo e(url('/api/info/get_ym_info')); ?>",
    //     {
    ...
    $('#js-btn').click(function(){
        $.post("<?php echo e(url('/api/merchant/login')); ?>",
        {
            phone:$('.js-tel').val(),
            password:$('.js-password').val(),
            login_type:"<?php echo e($_GET['login_type']); ?>"
        },
        function(res){
            console.log(res);
            if(res.status==303){
    ...
    $('.register-btn').click(function(){
        window.location.href = "<?php echo e(url('/school/register?register_type=')); ?>"+$('.js_type').val()+"&s_code="+$('.s_code').val();
    });
