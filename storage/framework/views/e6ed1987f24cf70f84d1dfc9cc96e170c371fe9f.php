        ...
        <div class="layui-fluid">
          <div class="layui-row layui-col-space15">
            ...
            <div class="qrcode" id="qrcode" style="width:595px;margin:50px auto">
              ...
              <div class="g_c_name"><img src="<?php echo e(asset('/layuiadmin/layui/images/banji-bg.png')); ?>" class="qr_img" download=""><span></span></div>
...
<div id="canvas_url" style="display: none"></div>
 ...
 <input type="hidden" class="js_class">
  ...
  <script src="<?php echo e(asset('/user/js/html2canvas.js')); ?>"></script> 
  <script src="<?php echo e(asset('/user/js/jquery.base64.js')); ?>"></script> 
  <script src="<?php echo e(asset('/layuiadmin/Print.js')); ?>"></script> 
  <!-- <script src="<?php echo e(asset('/layuiadmin/jquery.jqprint-0.3.js')); ?>"></script>  -->
    <script>
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        $.post("<?php echo e(url('/api/basequery/alipay_isv_info')); ?>",
        {
          store_id:store_id,                
        },function(res){
            console.log(res);
