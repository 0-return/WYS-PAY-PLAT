    ...
    <div class="layui-card">
        <div class="layui-card-body" style="margin:0">
            <div class="layui-form" lay-filter="component-form-group">
                ...
                <div class="layui-form-item" id="schoolgrade">
...
<script>
    ...
    var stu_class_no = localStorage.getItem("stu_class_no");
    var school_name = localStorage.getItem("school_name");
    var grade_no = localStorage.getItem("grade_no");
    ...
    layui.config({
        ...
        form.on('select(grade)', function(data){            
            category = data.value;  
            categoryName = data.elem[data.elem.selectedIndex].text; 
            $('.stu_grades_no').val(category);         
        });
       
        function getBoards(){ 
            // 显示修改的内容
            $.post("<?php echo e(url('/api/school/teacher/class/show')); ?>",
            {
                token:token,
                ...
                console.log(res);              
                $('.name').val(res.data.stu_class_name);
                $('.gradedesc').val(res.data.stu_class_desc);  
        ...
        $('.submit').on('click', function(){
            $.post("<?php echo e(url('/api/school/teacher/class/save')); ?>",
            {
                token:token,                
