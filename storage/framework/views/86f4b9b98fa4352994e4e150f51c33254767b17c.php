    ...
    layui.config({
        ...
        formSelects.selects({
            ...
            change:function(data, arr){                
                ...
                var trade1=arrid.join("");//将字符串用逗号隔开
                var trade2=arrname.join("");//将字符串用逗号隔开
                $('.schooltypename').val(trade2);
                $('.schooltypeid').val(trade1);
        ...
        function getBoards(){
            ...
            // 学校类型
            $.ajax({
                url : "<?php echo e(url('/api/school/teacher/typelst')); ?>",
                data : {token:token},
                type : 'post',
                success : function(data) {
                    console.log(data);
        ...
        $('.submit').on('click', function(){
            console.log('000');
            // window.parent.layui.element.tabChange('layadmin-layout-tabs', "<?php echo e(url('/merchantpc/schoollist')); ?>");
            ...
            $.post("<?php echo e(url('/api/school/teacher/add')); ?>",
            {
                token:token,
                ...
                if(res.status==1){
                    layer.msg(res.message, {
                        ...
                        element.tabAdd('demo', {
                           title: '学校列表'
                           ,id: "<?php echo e(url('/merchantpc/schoollist')); ?>"
                        });
                    });
