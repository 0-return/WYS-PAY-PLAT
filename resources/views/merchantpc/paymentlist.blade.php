              ...
              <div class="layui-card"> 
                ...
                <div class="layui-card-body">
                  <div class="layui-btn-container" style="font-size:14px;">
                    <div>
                      <a class="layui-btn layui-btn-primary" lay-href="{{url('/merchantpc/paymentitem')}}" style="display: inline-block;width: 120px;">添加缴费项目</a>
                      <a class="layui-btn layui-btn-primary" lay-href="{{url('/merchantpc/importbill')}}" style="display: inline-block;width: 120px;">导入缴费项目</a>
                  ...
                  <script type="text/html" id="table-content-list" class="layui-btn-small">
                    ...
                    @{{#  if(d.batch_create_type == 2){ }}
                      <a class="layui-btn layui-btn-normal layui-btn-xs edit" lay-event="edit" lay-href="{{url('/merchantpc/editpayment')}}" style="display: none">项目修改</a>
                    @{{#  } else { }}
        ...
        table.on('tool(test-table-page)', function(obj){ //注：tool是工具条事件名，test是table原始容器的属性 lay-filter="对应的值"
          ...
          if(layEvent === 'shenhe'){ //审核
            ...
            layer.confirm('删除项目后无法恢复，请确认后在操作。',{icon: 2}, function(index){
              ...
              $.ajax({
                url : "{{url('/api/school/teacher/payitem/del')}}",
                data : {token:token,stu_order_batch_no:e.stu_order_batch_no},
                type : 'post',
                success : function(data) {
                  console.log(data);
