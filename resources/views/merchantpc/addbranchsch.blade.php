    ...
    layui.config({
        ...
        function getBoards(){
            ...
            $.ajax({
                ...
                data : {token:token,return_type:'1'},
                type : 'post',
                success : function(data) {
                    console.log(data);
                    var optionStr = "";
        ...
        // var parsent_store_id = sessionStorage.getItem("parsent_store_id");//获取上级学校pid
        var parsent_store_id = localStorage.getItem("parsent_store_id");
        ...
        $('.submit').on('click', function(){
            ...
            {
                token:token,
                parent_store_id:parsent_store_id,
