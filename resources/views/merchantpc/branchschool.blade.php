          ...
          <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
              <div class="layui-card"> 
                <div class="layui-card-header">总校:<span></span></div>

                <div class="layui-card-body">
                  <div class="layui-btn-container">                    
                    <a class="layui-btn layui-btn-primary addschool" lay-href="">添加分校</a>
                  </div>
                  ...
                  <script type="text/html" id="table-content-list">
                    ...
                    <a class="layui-btn layui-btn-normal layui-btn-xs edit" lay-event="edit" lay-href="">分校修改</a>
  ...
  <script src="{{asset('/layuiadmin/layui/layui.js')}}"></script> 
    ...
    layui.config({
      base: '../../layuiadmin/' //静态资源所在路径
        ...
        $('.layui-card-header span').html(school_name);
        $('.addschool').attr('lay-href',"{{url('/merchantpc/addbranchsch')}}");
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{width:350,align:'center', fixed: 'right', toolbar: '#table-content-list',title: '操作'}
            ]]
            ,response: {
