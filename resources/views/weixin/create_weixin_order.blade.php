...
<script type="text/javascript">
    var jump_success = "{{url('weixin/order/success')}}";
    var jump_fail = "{{url('weixin/order/fail')}}";

    $(function () {
        function onBridgeReady() {
            var url = "{{url('/api/merchant/qr_auth_pay')}}";
            var data =
                {
            ...
            $.post(url, data,
                function (back) {
                    ...
                    $('.load-hiddenbg').hide();
                    var data_url = "&total_amount=" + $("#total_amount").html() + "&store_id=" + $("#store_id").val();
