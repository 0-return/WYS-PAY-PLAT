            ...
            <div class="layui-row box3 layui-form">
                ...
                <div class="layui-col-md6"> 
                    <div class="layui-form-item">                    
                        ...
                        <div class="layui-input-block bank" style="width:130px;overflow: hidden;display: inline-block;margin-left:20px;">
                            <div class="img photo4"><img src="{{asset('/school/images/zanwu.png')}}"></div>
                        ...
                        <div class="layui-input-block different" style="width:130px;overflow: hidden;display: inline-block;margin-left:20px;">
                            <div class="img photo1"><img src="{{asset('/school/images/zanwu.png')}}"></div>
                            <label class="layui-form-label">持卡人身份证正面</label>
                        </div> 
                        <div class="layui-input-block different" style="width:130px;overflow: hidden;display: inline-block;margin-left:20px;">
                            <div class="img photo2"><img src="{{asset('/school/images/zanwu.png')}}"></div>
                            <label class="layui-form-label">持卡人身份证反面</label>
                        </div>
                        <div class="layui-input-block different" style="width:130px;overflow: hidden;display: inline-block;margin-left:20px;">
                            <div class="img photo3"><img src="{{asset('/school/images/zanwu.png')}}"></div>
            ...
            <div class="layui-col-md6"> 
                <div class="layui-form-item">                    
                    ...
                    <div class="layui-input-block per" style="width:130px;overflow: hidden;display: inline-block;margin-left:110px;">
                        <div class="img license3"><img class="holdsfz" src="{{asset('/school/images/zanwu.png')}}"></div>
                    ...
                    <div class="layui-input-block per" style="width:130px;overflow: hidden;display: inline-block;margin-left:20px;">
                        <div class="img license4"><img class="doorsfz" src="{{asset('/school/images/zanwu.png')}}"></div>
...
<div id="photo1" class="hide" style="display: none"><img style="width:100%;height:100%" src="{{asset('/school/images/zanwu.png')}}"></div> 
<div id="photo2" class="hide" style="display: none"><img style="width:100%;height:100%" src="{{asset('/school/images/zanwu.png')}}"></div> 
<div id="photo3" class="hide" style="display: none"><img style="width:100%;height:100%" src="{{asset('/school/images/zanwu.png')}}"></div> 
<div id="photo4" class="hide" style="display: none"><img style="width:100%;height:100%" src="{{asset('/school/images/zanwu.png')}}"></div> 
