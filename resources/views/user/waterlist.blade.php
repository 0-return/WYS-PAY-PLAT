          ...
          <div class="layui-row layui-col-space15">
            <div class="layui-col-md12">
              <div class="layui-card"> 
                <div class="layui-card-header">交易流水</div>
  ...
  <script src="{{asset('/layuiadmin/layui/layui.js')}}"></script> 
    ...
    layui.config({
      ...
      $(document).ready(function(){        
        ...
        // 选择年级
        // $.ajax({
        //     url : "{{url('/api/school/agent/grade/lst')}}",
        //     data : {token:token},
        //     type : 'post',
        //     success : function(data) {
        //         // console.log(data);
        ...
        // 选择班级
        // $.ajax({
        //     url : "{{url('/api/school/agent/class/lst')}}",
        //     data : {token:token},
        //     type : 'post',
        //     success : function(data) {
        //         console.log(data);
        ...
        // 选择缴费项目
        $.ajax({
            url : "{{url('/api/school/agent/batch/lst')}}",
            data : {token:token},
            type : 'post',
            success : function(data) {
                console.log(data);
        ...
        table.render({
            ...
            ,url: "{{url('/api/school/agent/order/lst')}}"
            ,method: 'post'
            ,where:{
              token:token,   
              store_id:store_id           
        ...
        form.on('select(grade)', function(data){
          ...
          $.ajax({
            url : "{{url('/api/school/agent/class/lst')}}",
            data : {token:token,store_id:$('.store_id').val(),stu_grades_no:stu_grades_no},
            type : 'post',
            success : function(data) {
                console.log(data);
                var optionStr = "";
